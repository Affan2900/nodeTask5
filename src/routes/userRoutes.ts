...
router.post('/users', validateUserCreate, authService.registerUser as RequestHandler);
router.put('/users/:id',validateUserUpdate, userController.updateUser as RequestHandler);
router.patch('/users/:id',validateUserUpdate, userController.updateUser as RequestHandler);
